...
import { PostAdStateType } from 'hooks';
...
type AdditionalInformationProps = {
  ...
  handleExtrasChange: (event: React.ChangeEvent<HTMLInputElement>) => void;
  register: any;
  errors: any;
  postAdState: PostAdStateType;
};
              ...
              (item, key) =>
                item.category_id === '1' && (
                  <Checkbox
                    ...
                    key={key}
                    checked={postAdState.adExtras.includes(item.id.toString())}
